...
const getTokenLogoURL3 = (name: string) =>
...
export default function CurrencyLogo({
  ...
  const srcs: string[] = useMemo(() => {
    ...
    return [getTokenLogoURL(currency?.symbol as string), getTokenLogoURL2(currency instanceof Token ? currency?.address as string : ""), getTokenLogoURL3(currency?.name?.toLowerCase() as string)]
