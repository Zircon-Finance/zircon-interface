...
const pools: SerializedPoolConfig[] = [
  {
    ...
    token2: new Token(ChainId.MOONRIVER, '0x98878b06940ae243284ca214f92bb71a2b032b8a', 18, 'wMOVR', 'Moonriver'),
    isClassic: false,
    isAnchor: false,
    earningToken: [new Token(MOONRIVER, '0x98878B06940aE243284CA214f92Bb71a2b032B8A', 18, 'wMOVR', 'MoonRiver'),
