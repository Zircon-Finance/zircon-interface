...
export const fetchGammas = async (chainId: number, pools: SerializedPoolConfig[]): Promise<any[]> => {
    ...
    const farmMultiCallResult = await multicall(chainId, PYLON_ABI, farmCalls)
