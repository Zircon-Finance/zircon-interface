        ...
        <>
          <div>
            ...
            <Flex>
              ...
              <span style={{color: theme.text1, fontSize: '16px', marginRight: '3px'}}>{!isClassic && (!isAnchor ? token.symbol : quoteToken.symbol)} </span>{isClassic ? 'CLASSIC' :!isAnchor ? 'FLOAT' : 'ANCHOR'}
              </BadgeSmall>
